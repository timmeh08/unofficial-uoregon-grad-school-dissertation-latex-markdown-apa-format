...
\begin{figure}[htbp]
    ...
    \caption{Comparison between data and pre-fit background estimates in the low \metsig\ CR (\ref{fig:lowmetsig-vr}) and the low $\Delta\phi$ VR (\ref{fig:lowdphi-vr}), enriched of \jfakey. The uncertainty includes both statistical and systematic contributions from the \efakey\ and \jfakey\ data-driven methods.}
    \label{fig:VRs}
\end{figure}
