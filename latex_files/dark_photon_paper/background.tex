...
\begin{figure}
    \centering
    \includegraphics[width=0.5\textwidth]{../images/clean_dark_photon_paper/clean_canvas_paper_ye_ymu_rebinned.pdf}
...
\begin{figure}[htbp]
    ...
    \includegraphics[width=0.4\textwidth]{../images/clean_dark_photon_paper/clean_LowMTVR.pdf}
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.5\textwidth]{../images/clean_dark_photon_paper/clean_canvas_paper_isol_extr_closure_L4_deltaE_liny.pdf}
...
\begin{figure}[htbp]
    ...
    \subfloat[]{\includegraphics[width=0.4\textwidth]{../images/clean_dark_photon_paper/clean_mt_lowMETsigPR.pdf}\label{fig:lowmetsig-vr}}
    \hspace{0.05\textwidth}
    %\subfloat[]{\includegraphics[width=0.4\textwidth]{figures/mt_lowDphiVR2_BDT01Data_.pdf}\label{fig:lowdphi-vr}}
    \subfloat[]{\includegraphics[width=0.4\textwidth]{../images/clean_dark_photon_paper/clean_mt_lowDphiPR.pdf}\label{fig:lowdphi-vr}}
