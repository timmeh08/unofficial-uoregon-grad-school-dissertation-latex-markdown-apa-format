...
\end{table}
 \begin{figure}[!htbp]
     \centering
     \includegraphics[trim=0 5cm 0 4cm, clip, width=\linewidth]{../images/dark_photon_paper/bdt-purity.pdf}
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=0.85\linewidth]{../images/dark_photon_paper/regions-sketch.pdf}
