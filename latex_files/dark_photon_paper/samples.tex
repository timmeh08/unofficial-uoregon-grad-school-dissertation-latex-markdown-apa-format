...
The list of samples used in the analysis is summarised in appendix~\ref{app:dark_photon_mc}.
...
\begin{figure}[ht]
    \centering
    \subfloat[]{\includegraphics[width=0.40\linewidth]{../images/clean_dark_photon_paper/clean_trigger_mt_full.png}\label{fig:trig_mt}}\\
    \subfloat[]{\includegraphics[width=0.40\linewidth]{../images/clean_dark_photon_paper/clean_trigger_ph_pt_full.png}\label{fig:trig_phpt}}
    \subfloat[]{\includegraphics[width=0.40\linewidth]{../images/clean_dark_photon_paper/clean_trigger_metnew_full.png}\label{fig:trig_met}}
    \caption{Trigger efficiency curves as function of \mT\ (a), \pTy\ (b), and \pTmiss\ (c), for data, MC simulation of the dominant background $W\gamma$ and total background. The \textit{baseline} selections are applied together with the selection $\dphimety>1.25$. Events selected by single-muon baseline trigger, containing one photon and one muon treated as invisible in the evaluation of \pTmiss\ and \mT, are used.}
