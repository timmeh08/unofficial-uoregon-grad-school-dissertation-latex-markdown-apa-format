...
\begin{figure}
    \centering
    \subfloat[]{\includegraphics[width=0.4\linewidth]{../images/dark_photon_paper/SR_postFit.pdf}\label{fig:sr}}
    \subfloat[]{\includegraphics[width=0.4\linewidth]{../images/dark_photon_paper/LowMETsigVR_postFit.pdf}\label{fig:lowmetsig}}
    \\
    \subfloat[]{\includegraphics[width=0.4\linewidth]{../images/dark_photon_paper/OneMuCR_postFit.pdf}\label{fig:onemu}}
    \subfloat[]{\includegraphics[width=0.4\linewidth]{../images/dark_photon_paper/TwoMuCR_1bin_postFit.pdf}\label{fig:twomu}}
    \caption{Distribution of \mT\ for data and for the expected SM background after the background-only fit, in the SR (\ref{fig:sr}) and CRs (\ref{fig:lowmetsig}, \ref{fig:onemu}, \ref{fig:twomu}). The $H\to\gamma\gamma_d$ signal with $\br=1\%$ is shown as a dashed red line, including the ggF, VBF, WH and ZH channels. The pre-fit prediction is overlaid as a dashed blue line. The uncertainties include both the statistical and the systematic component determined by the multiple-bin fit. The lower panel shows the ratio of data to expected background event yields post-fit (black dots) and pre-fit (dashed blue line).}
...
\begin{figure}
    \centering
    \includegraphics[width=0.75\linewidth]{../images/dark_photon_paper/Summary_postFit_VR.pdf}
    \caption{
...
\begin{figure}
    \centering
    \includegraphics[width=0.7\linewidth]{../images/dark_photon_paper/limits_mu_SIG_v3_bugfix.pdf}
