...
%--- Appendix A ---------------------------------------------------------------%
\chapter{Shell count studies for the USCA algorithm}\label{shell_studies}
...
\begin{figure}[h!]
    \centering
    \includegraphics[width=.49\textwidth]{../images/clean_my_images/eta_cut_plots/clean_cluster_etnormal_etacut_HH4b.png}
    \includegraphics[width=.49\textwidth]{../images/clean_my_images/eta_cut_plots/clean_cluster_leadinget_etacut_HH4b.png}
    \includegraphics[width=.49\textwidth]{../images/clean_my_images/eta_cut_plots/clean_cluster_totalet_etacut_HH4b.png}
...
\begin{figure}[h!]
    \centering
    \includegraphics[width=.49\textwidth]{../images/clean_my_images/eta_cut_plots/clean_cluster_mult_etacut_HH4b.png}
    \includegraphics[width=.49\textwidth]{../images/clean_my_images/eta_cut_plots/clean_2d_plot_etacut_HH4b.png}
    \includegraphics[width=.49\textwidth]{../images/clean_my_images/eta_cut_plots/clean_cluster_etas_etacut_HH4b.png}
...
\begin{figure}[h!]
    \centering
    \includegraphics[width=.99\textwidth]{../images/clean_my_images/eta_cut_plots/clean_jetpt_etacut_HH4b.png}
...
\begin{figure}[h!]
    \centering
    \includegraphics[width=.49\textwidth]{../images/clean_my_images/eta_cut_plots/clean_HH4b_jetturnon_0.png}
    \includegraphics[width=.49\textwidth]{../images/clean_my_images/eta_cut_plots/clean_HH4b_jetturnon_2.png}
...
\begin{figure}[h!]
    \centering
    \includegraphics[width=.49\textwidth]{../images/clean_my_images/plots/clean_Etcomparisonclustercut_jets_extended_JZ0W2.png}
    \includegraphics[width=.49\textwidth]{../images/clean_my_images/plots/clean_Etcomparisonclustercut_jets_extended_JZ0W3.png}
    \includegraphics[width=.49\textwidth]{../images/clean_my_images/plots/clean_Etcomparisonclustercut_jets_extended_HH4b2.png}
    \includegraphics[width=.49\textwidth]{../images/clean_my_images/plots/clean_Etcomparisonclustercut_jets_extended_HH4b3.png}
...
\begin{figure}[h!]
    \centering
    \includegraphics[width=.49\textwidth]{../images/clean_my_images/plots/clean_ratiocalib_jets_extended_JZ0W20.png}
    \includegraphics[width=.49\textwidth]{../images/clean_my_images/plots/clean_ratiocalib_jets_extended_JZ0W30.png}
    \includegraphics[width=.49\textwidth]{../images/clean_my_images/plots/clean_ratiocalib_jets_extended_HH4b20.png}
    \includegraphics[width=.49\textwidth]{../images/clean_my_images/plots/clean_ratiocalib_jets_extended_HH4b30.png}
...
\begin{figure}[h!]
    \centering
    \includegraphics[width=.49\textwidth]{../images/clean_my_images/plots/clean_ratiocalib_jets_extended_JZ0W24200.png}
    \includegraphics[width=.49\textwidth]{../images/clean_my_images/plots/clean_ratiocalib_jets_extended_JZ0W34200.png}
...
\setcounter{figure}{0}
\setcounter{table}{0}
\chapter{Dark Meson MC samples}\label{app:list_of_mc_samples}
\input{dark_meson_tex/appendix_mc_samples.tex}

%--- Appendix C ---------------------------------------------------------------%
\setcounter{figure}{0}
\setcounter{table}{0}
\chapter{N-dimensional ABCD method for the dark meson search}\label{app:NDABCD}
\input{dark_meson_tex/NDABCD.tex}

% --- Appendix D ---------------------------------------------------------------%
\setcounter{figure}{0}
\setcounter{table}{0}
\chapter{Dark Photon MC samples}\label{app:dark_photon_mc}
