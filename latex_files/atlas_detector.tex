...
The triangle shape is the ionization drift inside the detector.
A capacitively coupled input forces the shaped pulse to have a total integral of zero, canceling out contributions from out-of-time pileup.
...
It is important to note that while 1 kHz is the target rate, the actual rate is allowed to be higher in practice, and there are multiple streams of physics data.
...
The FEXes use custom FPGA-based hardware to implement fast algorithms for reconstruction within the L1 latency budget.
