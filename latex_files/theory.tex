...
In order to explore these possibilities experimentally, there must be some particle(s) that mediate the interactions between the dark sector and the Standard Model, and have an accessible mass scale for current experiments such as the LHC.
