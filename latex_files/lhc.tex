...
The HL-LHC will increase the instantaneous luminosity to $7.5\times10^{34}$ cm$^{-2}$s$^{-1}$, with a goal of collecting up to 3000 fb$^{-1}$ of integrated luminosity and reach the design COM energy of 14 TeV over a decade of operation \cite{Apollinari:2284929}.
Pileup is expected to reach an average of 200 interactions per bunch crossing, requiring significant upgrades to the LHC and experiments.
Chapter \ref {ch:hl-lhc-atlas-upgrades} will discuss the HL-LHC and corresponding upgrades to ATLAS in more detail.

\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.8\textwidth]{../images/my_images/HL-LHC-Plan_January2025.png}
    \caption{LHC and HL-LHC operation timeline \cite{Apollinari:2284929}.}
