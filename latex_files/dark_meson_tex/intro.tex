...
\begin{figure}[tbp]
  ...
  \centering
  \begin{subfigure}{0.31\textwidth}\centering\includegraphics[page=6,width=\textwidth]{../images/dark_meson/FeynmanDiagram.pdf}\phantomsubcaption\label{fig:FeynmanW}\end{subfigure} \hspace{2mm}
  %\subfloat[]{\includegraphics[page=7,width=0.32\textwidth]{FeynmanDiagram.pdf}\label{fig:FeynmanB}} %\hspace{20mm}
  \begin{subfigure}{0.31\textwidth}\centering\includegraphics[page=2,width=\textwidth]{../images/dark_meson/FeynmanDiagram.pdf}\phantomsubcaption\label{fig:FeynmanDY}\end{subfigure} \hspace{2mm}
  \begin{subfigure}{0.31\textwidth}\centering\includegraphics[width=\textwidth]{../images/dark_meson/pionttbb.pdf}\phantomsubcaption\label{fig:FeynmanDecay}\end{subfigure} %\hspace{20mm}
...
\begin{figure}[tbp]
  ...
  \begin{subfigure}{0.495\textwidth}\centering\includegraphics[width=\textwidth]{../images/dark_meson/crossSections_su2l_gaugephobic.pdf}\phantomsubcaption\label{fig:crosssections_su2l}\end{subfigure}%
  \begin{subfigure}{0.495\textwidth}\centering\includegraphics[width=\textwidth]{../images/dark_meson/crossSections_su2r_gaugephobic.pdf}\phantomsubcaption\label{fig:crosssections_su2r}\end{subfigure}
...
\begin{figure}[tbp]
  % The plots have been produced with the plot_crossSections.C script which can be found in the dark meson git space: https://gitlab.cern.ch/darkmesonsearch/darkscripts/blob/master/plot_crossSections.C
  \centering
  \begin{subfigure}{0.495\textwidth}\centering\includegraphics[page=3,width=\textwidth]{../images/dark_meson/branchingFractions.pdf}\phantomsubcaption\label{fig:pi0branchingfraction}\end{subfigure}%
  \begin{subfigure}{0.495\textwidth}\centering\includegraphics[page=4,width=\textwidth]{../images/dark_meson/branchingFractions.pdf}\phantomsubcaption\label{fig:pipbranchingfraction}\end{subfigure}
