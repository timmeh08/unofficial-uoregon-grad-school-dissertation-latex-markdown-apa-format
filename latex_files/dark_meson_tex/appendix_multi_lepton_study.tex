...
\begin{figure}[tbp]
  ...
  \centering
  \begin{subfigure}{0.32\textwidth}\centering\includegraphics[width=\textwidth]{../images/dark_meson/eventSignature_SU2L_gaugephobic.pdf}\phantomsubcaption\label{fig:evtsignatureSU2L}\end{subfigure}%
  \begin{subfigure}{0.32\textwidth}\centering\includegraphics[width=\textwidth]{../images/dark_meson/eventSignature_SU2R_gaugephobic.pdf}\phantomsubcaption\label{fig:evtsignatureSU2R}\end{subfigure}
