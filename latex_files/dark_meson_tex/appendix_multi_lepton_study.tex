...
\begin{figure}[tbp]
  ...
  \centering
  \begin{subfigure}{0.32\textwidth}\centering\includegraphics[width=\textwidth]{../images/dark_meson/clean_eventSignature_SU2L_gaugephobic.pdf}\phantomsubcaption\label{fig:evtsignatureSU2L}\end{subfigure}%
  \begin{subfigure}{0.32\textwidth}\centering\includegraphics[width=\textwidth]{../images/dark_meson/clean_eventSignature_SU2R_gaugephobic.pdf}\phantomsubcaption\label{fig:evtsignatureSU2R}\end{subfigure}
...
\begin{figure}[tbp]
  ...
  \centering
  \begin{subfigure}{0.32\textwidth}\centering\includegraphics[page=3,width=\textwidth]{../images/dark_meson/branchingFractions.pdf}\phantomsubcaption\label{fig:pi0branchingfractions}\end{subfigure}%
  \begin{subfigure}{0.32\textwidth}\centering\includegraphics[page=4,width=\textwidth]{../images/dark_meson/branchingFractions.pdf}\phantomsubcaption\label{fig:pipmbranchingfractions}\end{subfigure}
...
\begin{figure}[h]
  % 
  \centering
  \includegraphics[width=0.49\textwidth, page=1]{../images/dark_meson/clean_multilep_eff.pdf}
  \includegraphics[width=0.49\textwidth, page=2]{../images/dark_meson/clean_multilep_eff.pdf} 
...
\begin{figure}[h]
  % 
  \centering
  \includegraphics[width=0.49\textwidth, page=1]{../images/dark_meson/clean_multilep_trig_eff.pdf}
  \includegraphics[width=0.49\textwidth, page=2]{../images/dark_meson/clean_multilep_trig_eff.pdf} 
...
\begin{figure}[h]
  % 
  \centering
  \includegraphics[width=0.49\textwidth, page=1]{../images/dark_meson/clean_weighted_multilep_unique.pdf}
  \includegraphics[width=0.49\textwidth, page=2]{../images/dark_meson/clean_weighted_multilep_unique.pdf} 
