...
A detailed list of all signal MC samples is given in appendix~\ref{app:list_of_mc_samples}, an overview of all simulated signal points and their distribution in $\eta$-$m_{\pi_D}$ space can be found in figure~\ref{fig:signalGrid}.
