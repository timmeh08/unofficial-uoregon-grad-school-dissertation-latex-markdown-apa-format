...
This analysis is performed using data from \pp collisions with $\sqrt{s}=13\,\TeV$ recorded by the ATLAS detector in 2015--2018. Only events for which all relevant subsystems were operational are considered. The data correspond to an integrated luminosity of $140.1\pm1.2\,\ifb$~\cite{DAPR-2021-01}.
