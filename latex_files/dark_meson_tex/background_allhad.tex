...
\begin{figure}[tb]
  \centering
  \includegraphics[width=0.65\textwidth]{../images/dark_meson/Region_labels_ABCDtable.pdf}
...
\begin{figure}[tb]
  \centering
  \includegraphics[width=0.99\textwidth]{../images/dark_meson/allhad_vr.pdf}
