...
\begin{figure}[btp]
  ...
  \begin{subfigure}{0.445\textwidth}
    \centering
    \includegraphics[width=\textwidth]{../images/dark_meson/limit_1lep_SU2L_gaugephobic_45.pdf}
    \phantomsubcaption\label{figaux:eta45}
  \end{subfigure}%
  \begin{subfigure}{0.445\textwidth}
    \centering
    \includegraphics[width=\textwidth]{../images/dark_meson/limit_1lep_SU2L_gaugephobic_35.pdf}
    \phantomsubcaption\label{figaux:eta35}
  \end{subfigure} \\
  \begin{subfigure}{0.445\textwidth}
    \centering
    \includegraphics[width=\textwidth]{../images/dark_meson/limit_1lep_SU2L_gaugephobic_25.pdf}
    \phantomsubcaption\label{figaux:eta25}
  \end{subfigure}%
  \begin{subfigure}{0.445\textwidth}
    \centering
    \includegraphics[width=\textwidth]{../images/dark_meson/limit_1lep_SU2L_gaugephobic_15.pdf}
    \phantomsubcaption\label{figaux:eta15}
  \end{subfigure}
...
\begin{figure}[btp]
  ...
  \begin{subfigure}{0.495\textwidth}
    \centering
    \includegraphics[width=\textwidth]{../images/dark_meson/limit_allhad_unblinded_2d_SU2L_gaugephobic.pdf}
    \phantomsubcaption\label{fig:allhad_limits}
  \end{subfigure}%
  \begin{subfigure}{0.495\textwidth}
    \centering
    \includegraphics[width=\textwidth]{../images/dark_meson/limit_2d_1lep_SU2L_gaugephobic.pdf}
    \phantomsubcaption\label{fig:1lep_limits}
  \end{subfigure}
