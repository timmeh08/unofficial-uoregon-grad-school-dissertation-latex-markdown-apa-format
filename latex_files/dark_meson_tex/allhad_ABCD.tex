...
\begin{align*}
  ...
  N_F &= \frac{N_E}{N_A}
\end{align*}
using data - MC values from table ~\ref{fig:ABCDdataMC}. The estimate shown is 16\% low for this region implying that there is a correlation between these tag states.
