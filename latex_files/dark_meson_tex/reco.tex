...
To resolve any reconstruction ambiguities between electrons, muons and jets, an overlap removal procedure is applied in a prioritized sequence, based on baseline leptons and jets, as follows. First, if an electron shares the same ID track with another electron, the electron with lower \pt is discarded, and then any electron sharing the same ID track with a muon is rejected. 
