...
\begin{figure}[tb]
  \centering
  \subfloat[]{ \includegraphics[width=0.495\textwidth]{../images/dark_meson/allhad_Jets_12_m_0.pdf}\phantomsubcaption\label{fig:leadingJetMass}}
  \subfloat[]{\includegraphics[width=0.495\textwidth]{../images/dark_meson/allhad_Jets_12_m_1.pdf}\phantomsubcaption\label{fig:subleadingJetMass}}
...
\begin{figure}[btp]
    \centering
    \subfloat[]{ \includegraphics[width=0.495\textwidth]{../images/dark_meson/deltaRLep2ndClosestBJet.pdf}\phantomsubcaption\label{fig:deltaR}}
     \subfloat[]{\includegraphics[width=0.495\textwidth]{../images/dark_meson/bb_m_for_minDeltaR.pdf}\phantomsubcaption\label{fig:bbm}}    
