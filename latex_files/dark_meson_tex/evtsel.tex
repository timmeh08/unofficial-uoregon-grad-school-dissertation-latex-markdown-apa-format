...
\begin{figure}[tb]
  \centering
  \begin{subfigure}{0.495\textwidth}\centering\includegraphics[width=\textwidth]{../images/dark_meson/allhad_Jets_12_m_0.pdf}\phantomsubcaption\label{fig:leadingJetMass}\end{subfigure}%
  \begin{subfigure}{0.495\textwidth}\centering\includegraphics[width=\textwidth]{../images/dark_meson/allhad_Jets_12_m_1.pdf}\phantomsubcaption\label{fig:subleadingJetMass}\end{subfigure}
...
\begin{figure}[btp]
    \centering
    \begin{subfigure}{0.495\textwidth}\centering\includegraphics[width=\textwidth]{../images/dark_meson/deltaRLep2ndClosestBJet.pdf}\phantomsubcaption\label{fig:deltaR}\end{subfigure}%
    \begin{subfigure}{0.495\textwidth}\centering\includegraphics[width=\textwidth]{../images/dark_meson/bb_m_for_minDeltaR.pdf}\phantomsubcaption\label{fig:bbm}\end{subfigure}
...
\begin{figure}[btp]
  \centering
  \includegraphics[width=0.495\textwidth]{../images/dark_meson/LJet_m_plus_RCJet_m_12.pdf}
