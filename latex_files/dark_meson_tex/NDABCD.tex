...
\begin{figure}[htb]
  \centering
    \caption{4D ABCD estimate region definitions. These labels have been chosen to agree with the notation used in~\cite{ATL-COM-PHYS-2016-1696}. Tag definitions are described in the main body in table~\ref{tab:SR_tags}.}
