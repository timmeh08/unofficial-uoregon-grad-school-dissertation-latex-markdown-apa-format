...
\begin{figure}[h!]
    \centering
    \includegraphics[width=0.99\textwidth]{../images/my_images/figures/itk_longitudinal.png}
...
\begin{figure}[h!]
    \centering
    \includegraphics[width=\textwidth]{../images/my_images/figures/run4_tdaq.png}
...
A stand-alone {\fontfamily{cmtt}\selectfont python} package \footnote{\href{https://gitlab.cern.ch/tmathew/topo_code }{\normalfont \slshape https://gitlab.cern.ch/tmathew/topo_code}} encodes the cell $E_T$ into 10-bit binary strings following Table \ref{binary}, and the cell IDs (which contains position information) into 32-bit strings organized by event and position in $\eta$ and $\phi$ space.
