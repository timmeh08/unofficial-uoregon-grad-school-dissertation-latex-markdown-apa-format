...
\begin{figure}[!htbp]
    \centering
    \includegraphics[width=0.5\textwidth]{../images/clean_my_images/clean_itk_longitudinal.png}
...
\begin{figure}[!htbp]
    \centering
    \includegraphics[width=0.5\textwidth]{../images/clean_my_images/clean_run4_tdaq.png}
...
\begin{figure}[!htbp]
    \centering
    \includegraphics[width=\textwidth]{../images/clean_my_images/figures/global.png}
...
\begin{figure}[!htbp]
    \centering
    \includegraphics[width=.49\textwidth]{../images/clean_my_images/plots/clean_cell_et_JZ0W.png}
    \includegraphics[width=.49\textwidth]{../images/clean_my_images/plots/clean_cell_et_HH4b.png}
...
\begin{figure}[!htbp]
    \centering
    \includegraphics[width=0.49\textwidth]{../images/clean_my_images/figures/calorimeters.png}
    \includegraphics[width=0.49\textwidth]{../images/clean_my_images/figures/2d_clusters.png}
    \includegraphics[width=0.9\textwidth]{../images/clean_my_images/figures/lar_cells.png}
...
\begin{figure}[!htbp]
    \centering
    \includegraphics[width=0.99\textwidth]{../images/clean_my_images/figures/FSSM.png}
...
\begin{figure}[!htbp]
    \centering
    \includegraphics[width=0.99\textwidth]{../images/clean_my_images/figures/FSSM_cluster.png}
...
\begin{figure}[!htbp]
    \centering
    \includegraphics[width=0.49\textwidth]{../images/clean_my_images/plots/clean_percent_overlap_JZ0W.png}
    \includegraphics[width=0.49\textwidth]{../images/clean_my_images/plots/clean_percent_overlap_HH4b.png}
...
\begin{figure}[!htbp]
    \centering
    \includegraphics[width=0.99\textwidth]{../images/clean_my_images/plots/clean_cells_2d.png}
...
\begin{figure}[!htbp]
    \centering
    \includegraphics[width=.45\textwidth]{../images/clean_my_images/figures/gtp.png}
...
\begin{figure}[!htbp]
    \centering
    \includegraphics[width=.49\textwidth]{../images/clean_my_images/plots/clean_cluster_etnormal_etacut_JZ0W.png}
    \includegraphics[width=.49\textwidth]{../images/clean_my_images/plots/clean_cluster_etnormal_etacut_HH4b.png}
...
\begin{figure}[!htbp]
    \centering
    \includegraphics[width=.49\textwidth]{../images/clean_my_images/plots/clean_cluster_leadinget_etacut_JZ0W.png}
    \includegraphics[width=.49\textwidth]{../images/clean_my_images/plots/clean_cluster_leadinget_etacut_HH4b.png}
    \includegraphics[width=.49\textwidth]{../images/clean_my_images/plots/clean_cluster_totalet_etacut_JZ0W.png}
    \includegraphics[width=.49\textwidth]{../images/clean_my_images/plots/clean_cluster_totalet_etacut_HH4b.png}
...
\begin{figure}[!htbp]
    \centering
    \includegraphics[width=.49\textwidth]{../images/clean_my_images/plots/clean_cluster_etas_etacut_JZ0W.png}
    \includegraphics[width=.49\textwidth]{../images/clean_my_images/plots/clean_cluster_etas_etacut_HH4b.png}
...
\begin{figure}[!htbp]
    \centering
    \includegraphics[width=.49\textwidth]{../images/clean_my_images/plots/clean_2d_plot_etacut_JZ0W.png}
    \includegraphics[width=.49\textwidth]{../images/clean_my_images/plots/clean_2d_plot_etacut_HH4b.png}
...
\begin{figure}[!htbp]
    \centering
    \includegraphics[width=.49\textwidth]{../images/clean_my_images/plots/clean_cluster_mult_etacut_JZ0W.png}
    \includegraphics[width=.49\textwidth]{../images/clean_my_images/plots/clean_cluster_mult_etacut_HH4b.png}
...
\begin{figure}[!htbp]
    \centering
    \includegraphics[width=.49\textwidth]{../images/clean_my_images/plots/clean_num_cells_clus_JZ0W.png}
    \includegraphics[width=.49\textwidth]{../images/clean_my_images/plots/clean_num_cells_clus_HH4b.png}
...
Even though 2- to 3-shell clusters can have more than 25 cells before merging, the plots show that on average, post-merged clusters have roughly half that number or less for signal and background events.
...
\begin{figure}[!htbp]
    \centering
    \includegraphics[width=.49\textwidth]{../images/clean_my_images/plots/clean_cluster_etmissx_etacut_JZ0W.png}
    \includegraphics[width=.49\textwidth]{../images/clean_my_images/plots/clean_cluster_etmissy_etacut_JZ0W.png}
    \includegraphics[width=.49\textwidth]{../images/clean_my_images/plots/clean_cluster_etmissx_etacut_HH4b.png}
    \includegraphics[width=.49\textwidth]{../images/clean_my_images/plots/clean_cluster_etmissy_etacut_HH4b.png}
...
\begin{figure}[!htbp]
    \centering
    \includegraphics[width=.49\textwidth]{../images/clean_my_images/plots/clean_jetpt_etacut_JZ0W.png}
    \includegraphics[width=.49\textwidth]{../images/clean_my_images/plots/clean_jetpt_etacut_HH4b.png}
...
\begin{figure}[!htbp]
    \centering
    \includegraphics[width=.49\textwidth]{../images/clean_my_images/plots/clean_jeteta_JZ0W.png}
    \includegraphics[width=.49\textwidth]{../images/clean_my_images/plots/clean_jeteta_HH4b.png}
...
\begin{figure}[!htbp]
    \centering
    \includegraphics[width=.49\textwidth]{../images/clean_my_images/plots/clean_HH4b_jetturnon_etcut_0.png}
    \includegraphics[width=.49\textwidth]{../images/clean_my_images/plots/clean_HH4b_jetturnon_etcut_1.png}
    \includegraphics[width=.49\textwidth]{../images/clean_my_images/plots/clean_HH4b_jetturnon_etcut_2.png}
    \includegraphics[width=.49\textwidth]{../images/clean_my_images/plots/clean_HH4b_jetturnon_etcut_3.png}
...
\begin{figure}[!htbp]
    \centering
    \includegraphics[width=.49\textwidth]{../images/clean_my_images/plots/clean_HH4b_fixedrate_etcut_0.png}
    \includegraphics[width=.49\textwidth]{../images/clean_my_images/plots/clean_HH4b_fixedrate_etcut_1.png}
    \includegraphics[width=.49\textwidth]{../images/clean_my_images/plots/clean_HH4b_fixedrate_etcut_2.png}
    \includegraphics[width=.49\textwidth]{../images/clean_my_images/plots/clean_HH4b_fixedrate_etcut_3.png}
...
\begin{figure}[!htbp]
    \centering
    \includegraphics[width=.49\textwidth]{../images/clean_my_images/plots/clean_HH4b_jetturnon_fixedrate_etcut_0.png}
    \includegraphics[width=.49\textwidth]{../images/clean_my_images/plots/clean_HH4b_jetturnon_fixedrate_etcut_1.png}
    \includegraphics[width=.49\textwidth]{../images/clean_my_images/plots/clean_HH4b_jetturnon_fixedrate_etcut_2.png}
    \includegraphics[width=.49\textwidth]{../images/clean_my_images/plots/clean_HH4b_jetturnon_fixedrate_etcut_3.png}
...
\begin{figure}[!htbp]
    \centering
    \includegraphics[width=.49\textwidth]{../images/clean_my_images/plots/clean_HH4b_fixedrate_proto_0.png}
    \includegraphics[width=.49\textwidth]{../images/clean_my_images/plots/clean_HH4b_fixedrate_proto_1.png}
    \includegraphics[width=.49\textwidth]{../images/clean_my_images/plots/clean_HH4b_fixedrate_proto_2.png}
    \includegraphics[width=.49\textwidth]{../images/clean_my_images/plots/clean_HH4b_fixedrate_proto_3.png}
...
\begin{figure}[!htbp]
    \centering
    \includegraphics[width=.49\textwidth]{../images/clean_my_images/plots/clean_HH4b_jetturnon_fixedrate_proto_0.png}
    \includegraphics[width=.49\textwidth]{../images/clean_my_images/plots/clean_HH4b_jetturnon_fixedrate_proto_1.png}
    \includegraphics[width=.49\textwidth]{../images/clean_my_images/plots/clean_HH4b_jetturnon_fixedrate_proto_2.png}
    \includegraphics[width=.49\textwidth]{../images/clean_my_images/plots/clean_HH4b_jetturnon_fixedrate_proto_3.png}
...
\begin{figure}[!htbp]
    \centering
    \includegraphics[width=.49\textwidth]{../images/clean_my_images/clean_test_vec.png}
    \includegraphics[width=.49\textwidth]{../images/clean_my_images/clean_test_vec_comparison.png}
...
\begin{figure}[!htbp]
    \centering
    \includegraphics[width=.55\textwidth]{../images/clean_my_images/figures/neighbors_list.png}
    \includegraphics[width=.45\textwidth]{../images/clean_my_images/figures/neighbors1.png}
    \includegraphics[width=.45\textwidth]{../images/clean_my_images/figures/neighbor2.png}
...
\begin{figure}[!htbp]
    \centering
    \includegraphics[width=.7\textwidth]{../images/clean_my_images/figures/translator.png}
...
\begin{figure}[!htbp]
    \centering
    \includegraphics[width=.49\textwidth]{../images/clean_my_images/atl_plots/clean_JZ0W_2sig.png}
    \includegraphics[width=.49\textwidth]{../images/clean_my_images/atl_plots/clean_JZ0W_4sig.png}
    \includegraphics[width=.49\textwidth]{../images/clean_my_images/atl_plots/clean_JZ0W_2sig_jet.png}
    \includegraphics[width=.49\textwidth]{../images/clean_my_images/atl_plots/clean_JZ0W_4sig_jet.png}
...
\begin{figure}[!htbp]
    \centering
    \includegraphics[width=.49\textwidth]{../images/clean_my_images/atl_plots/clean_HH4B_2sig.png}
    \includegraphics[width=.49\textwidth]{../images/clean_my_images/atl_plots/clean_HH4B_4sig.png}
    \includegraphics[width=.49\textwidth]{../images/clean_my_images/atl_plots/clean_HH4B_2sig_jet.png}
    \includegraphics[width=.49\textwidth]{../images/clean_my_images/atl_plots/clean_HH4B_4sig_jet.png}
