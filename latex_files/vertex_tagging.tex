...
This is a low track multiplicitiy environment, and tradition vertex tagging techniques are shown to be not as efficient, as described in section~\ref{sec:selections}.
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.6\textwidth]{../images/clean_vertexing/fake_met.png}
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.45\textwidth]{../images/clean_vertexing/clean_pv_baseline_vs_truth_ggHyyd.pdf}
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.45\textwidth]{../images/clean_vertexing/vertexing_fit.png}
    \includegraphics[width=0.45\textwidth]{../images/clean_vertexing/fit_goodreco6.png}
...
Two sets of training are performed: one on events without selections, and one with preselections applied as defined in section~\ref{sec:selections}, to evaluate the performance of the classifier in both scenarios.
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.45\textwidth]{../images/clean_vertexing/clean_feature_ph_vtx_gamma_jets.pdf}
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.45\textwidth]{../images/clean_vertexing/clean_prob_distribution_gammajet_frag_70_140_weighted.pdf}
    \includegraphics[width=0.45\textwidth]{../images/clean_vertexing/clean_prob_distribution_ggHyyd.pdf}
    \includegraphics[width=0.45\textwidth]{../images/clean_vertexing/clean_prob_distribution_gammajet_frag_70_140_presel_weighted.pdf}
    \includegraphics[width=0.45\textwidth]{../images/clean_vertexing/clean_prob_distribution_ggHyyd_presel.pdf}
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.9\textwidth]{../images/clean_vertexing/table_results.png}
...
The $\Delta z$ between the reconstructed primary vertex and the true vertex is also plotted for both the standard vertex tagging method and the neural network classifier, as shown in Fig.~\ref{delta_z}, for the training with preselections, and split by background and signal.
There is a significant improvement in the $\Delta z$ distribution for the neural network classifier, with a sharper peak around zero for correctly identified vertices, especially in the background slice, indicating that the classifier is more accurately identifying the primary vertex compared to the standard method.

\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.45\textwidth]{../images/clean_vertexing/clean_delta_z_combined_gammajet_vs_signal.pdf}
    \caption{The $\Delta z$ between the reconstructed primary vertex and the true vertex for both the standard vertex tagging method (solid) and the neural network classifier (dashed) with preselections applied, and split by background (red) and signal (blue). The neural network classifier shows a significant improvement in the $\Delta z$ distribution, with a sharper peak around zero for correctly identified vertices, especially in the background slice.}
    \label{delta_z}
\end{figure}
