...
The production cross sections for the these signals are ~$10^13$ times smaller than the total inelastic proton-proton cross section at the LHC, so these searches require sophisticated analysis techniques to separate the signal from the overwhelming background.
