...
Selected photons are additionally required to be isolated according to the \texttt{TightCaloOnly} Working Point (WP). An additional selection on the photon $p_{\mathrm{T}}$ is applied at event level, requiring one selected photon with $p_{\mathrm{T}}>50$ GeV. \\
Table~\ref{tab:object:photon} summarizes the selections, WPs and the calibration scheme used for selected and baseline photons. 
