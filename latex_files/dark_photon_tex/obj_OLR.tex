In order to solve ambiguities among overlapping objects, the standard overlap removal procedure is applied, using the \texttt{AssociationUtils} tool with baseline objects as input. 
